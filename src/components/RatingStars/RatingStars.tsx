  ...
  return (
    <ul className='my-3'>
      {Array(5)
        .fill(0)
        .map((_, index) => {
          const isActiveFilterStar = index === 5 - undefinedRating
          return (
                ...
                {Array(5)
                  ...
                  .map((_, indexStar) => {
                    if (indexStar < 5 - index) {
                      return (
                        <svg viewBox='0 0 9.5 8' className='m-1 h-4 w-4 ' key={indexStar}>
                          <defs>
                    ...
                    return (
                      <svg viewBox='0 0 30 30' className='m-1 h-4 w-4' key={indexStar}>
                        <defs>
